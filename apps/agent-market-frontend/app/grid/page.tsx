...
import GridAgentCard from "@/app/components/marketplace/GridAgentCard";
import { gridMarketplaceAgents } from "@/app/lib/gemini/catalog";
...
export default function GridPage() {
  const { t } = useI18n();
  const agents = gridMarketplaceAgents();
