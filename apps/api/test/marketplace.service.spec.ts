...
describe('MarketplaceService', () => {
  ...
  it('should filter by category from 8004scan results', async () => {
  ...
  it('should filter by protocol from 8004scan results', async () => {
  ...
  it('should filter by risk level from 8004scan results', async () => {
  ...
  it('should return ERC8004 agents from 8004scan', async () => {
  ...
  it('should sort by highest return', async () => {
    ...
    scan.listRegisteredAgents.mockResolvedValue({ items: [scanItem, secondItem], total: 2 });
  ...
  it('should fetch featured agents from 8004scan', async () => {
    const featured = await service.getFeatured(10);

    expect(scan.listRegisteredAgents).toHaveBeenCalledWith({
      limit: 10,
      offset: 0,
      isTestnet: false,
    });
